    ...
    while True:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                score += tempscore
                print(word+' earned '+str(tempscore)+' points. Total: '+str(score)+' points')
                print()
                # Update the hand 
...
def playGame(wordList, saved_hand):
    ...
    """
    # HAND = dealHand(7)
    # HAND = {'c': 2, 'b': 3, 'u': 1, 't': 1}
    # displayHand(HAND)
    # if isValidWord('cut', HAND, wordList):
    #     HAND = updateHand(HAND, 'cut')
    # else:
    #     print('Invalid word, please try again.')
    # displayHand(HAND)
